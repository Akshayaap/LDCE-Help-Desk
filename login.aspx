<%@ Page Title="LDCE | Login" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="login" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" style="height: 386px">
        ...
        <tr>
            ...
            <td  align="center">
                ...
                <asp:Button ID="btnSubmit" Font-Bold="true" Font-Size="Medium" BackColor="Crimson" AccessKey="L" ForeColor="FloralWhite" runat="server" Text="LOGIN"  Width="120px" OnClick="btnSubmit_Click"/>
                <br />
        ...
        <tr align="center" style="color:red;font-family:Arial;font-size:20px;">
            <td>


                <asp:Label ID="Label1" runat="server" Text="Username and Password You Entered are not Correct !!"></asp:Label>
