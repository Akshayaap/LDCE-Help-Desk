<%@ Page Title="LDCE | Change Password" Language="C#" MasterPageFile="~/adminMaster.master" AutoEventWireup="true" CodeFile="changePswdAdmin.aspx.cs" Inherits="changePswdAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%"  style="color:Maroon;" >
     ...
     <tr>
              <td style="width: 486px; background-color:Transparent; height: 29px;" align="right" valign="top" >
              ...
              <td style="width: 325px; background-color:Transparent; height: 29px;" align="left" valign="top" >
