<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.master" AutoEventWireup="true" CodeFile="specificUser.aspx.cs" Inherits="specificUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr align="center">
       ...
       <td align="right">
        ...
        <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnDelete" runat="server" Font-Bold="true" ForeColor="floralWhite" BackColor="crimson" Text="Delete Account"  />
                        </td>
        </tr>
    </table>
