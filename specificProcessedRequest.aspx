<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.master" AutoEventWireup="true" CodeFile="specificProcessedRequest.aspx.cs" Inherits="specificProcessedRequest" %>
   ...
   <tr>
            ...
            <tr>
                    <td align="center" colspan="2">
                        ...
                        <asp:Button ID="btnDeletereq" runat="server" Font-Bold="true" ForeColor="floralwhite" BackColor="crimson" Text="Delete Processed Query"  />
                    </td>
            </tr>
    </table>
</asp:Content>
