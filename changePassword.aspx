<%@ Page Title="LDCE | Change Password" Language="C#" MasterPageFile="~/studentMaster.master" AutoEventWireup="true" CodeFile="changePassword.aspx.cs" Inherits="changePassword" %>
