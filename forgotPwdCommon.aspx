<%@ Page Title="LDCE | Forgot Password" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="forgotPwdCommon.aspx.cs" Inherits="forgotPwdCommon" %>
     ...
     <table  width="100%">
        ...
        <tr>
            ...
            <td  align="center" style="width: 1070px">
                ...
                <asp:Button ID="btnSubmit" Font-Bold="true" ForeColor="floralWhite" BackColor="crimson" Font-Size="Medium"  AccessKey="L"  runat="server" Text="Submit"  Width="120px" />
                <br />
                <br />
