<%@ Page Title="LDCE | Feedback" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Feedback.aspx.cs" Inherits="Feedback" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="100%">
        ...
        <tr>
                    ...
                    <asp:Button ID="btnSubmitfeedback" runat="server" AccessKey="F" Text="SEND FEED BACK"  Font-Names="Bodoni MT Black" ForeColor="floralWhite" BackColor="crimson" Width="150px"/>
                    ...
                    <br />
                         ...
                         <asp:Button ID="btnCancel" runat="server" Text="CANCEL" CausesValidation="false" Width="113px" Font-Names="Bodoni MT Black" BackColor="crimson" ForeColor="FloralWhite" />
